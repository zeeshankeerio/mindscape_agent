...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[Test Add Contact] Original: ${phone_number}, Formatted: ${formattedPhone}`)
    ...
    console.log(`[Test Add Contact] Contact created successfully: ${contact.id}`)
    ...
    console.error("[Test Add Contact] Error:", error)
    return NextResponse.json({
      success: false,
